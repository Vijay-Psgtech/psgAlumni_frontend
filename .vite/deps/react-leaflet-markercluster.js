...
import_leaflet.default.MarkerClusterGroup.include({
...
import_leaflet.default.MarkerClusterGroup.addInitHook(function() {
  this._layerBuffer = [];
});
function createMarkerCluster(_ref, context) {
  var _c = _ref.children, props = _objectWithoutProperties(_ref, _excluded);
  var clusterProps = {};
  var clusterEvents = {};
  ...
  var instance = new import_leaflet.default.MarkerClusterGroup(clusterProps);
...
var esm_default = MarkerCluster;
export {
  esm_default as default
};
//# sourceMappingURL=react-leaflet-markercluster.js.map
